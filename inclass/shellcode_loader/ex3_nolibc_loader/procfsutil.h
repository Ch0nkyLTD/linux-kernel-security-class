 ...
 * This is the "reflective dialect" translation of find_libc.c.
 */
#ifndef PROCFSUTIL_H
#define PROCFSUTIL_H
                               ...
                               uintptr_t *base_out)
{
     ...
     */
    int fd = -1;
    // STACK_STR_PROC_SELF_MAPS(proc_path);
    // fd = sys_openat( ... );

    /* ── TODO 2: read the file into buf ───────────────────────
     *
     ...
     */
    (void)buf; (void)lib_needle; (void)prot; (void)base_out;
    (void)fd; (void)bytes_read;
